import pygame
import minigames.game_config  as gc

from pygame import display, event, image
from time import sleep
from minigames.animal import Animal
import minigames.animal

def run_match_game(screen):
    ...
    matched = image.load(r'C:\Users\noaha\OneDrive - University of Oklahoma\Spring 2023\Hacklahoma\Hacklahoma Project\PythonAttempt2\minigames\other_assets\matched.png')
    running = True
    ...
    gc.SCREEN_SIZE = 512
    gc.NUM_TILES_SIDE = 4
    gc.NUM_TILES_TOTAL = 16
    gc.MARGIN = 8
    minigames.animal.animals_count = dict((a, 0) for a in gc.ASSET_FILES)
